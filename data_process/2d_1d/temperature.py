...
files = ['Temperature profile [2].d6o']
...
def differences(i):
    ...
    brick_abs = abs_diff(brick_1d[i]['temperature'][:len(avg_2d)],
                         avg_2d)
    mortar_abs = abs_diff(mortar_1d[i]['temperature'][:len(avg_2d)],
                          avg_2d)
    brick_rel = rel_diff(brick_1d[i]['temperature'][:len(avg_2d)],
                         avg_2d)
    mortar_rel = rel_diff(mortar_1d[i]['temperature'][:len(avg_2d)],
                          avg_2d)
